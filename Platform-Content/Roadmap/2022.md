...
| iDaaS-Connect Industry Capabilities Analysis | Evaluating current industry standards needs based on ongoing interoperability updates. |
...
| Platform Component          | Description of Enhancement                                                                  |
|-----------------------------|---------------------------------------------------------------------------------------------|
| Platform Re-design Planning | This is the planning efforts based on the various work efforts done in August and September |
| DataSynthesis v4 Release    | Entensive DataSynthesis new version release                                                 |                                                                    |
...
| Platform Component          | Description of Enhancement                                                     |
|-----------------------------|--------------------------------------------------------------------------------|
| iDaaS-KIC                   | Re-development and implementation                                              |
| Defianz Test Implementation | Connecting Defianz and DataSynthesis together for an end to end implementation |                                                                   |

# Roadmap: 2022-12
The roadmap for December 2022.

Please reference the [Platform Component Specifics](../Design/PlatformComponents.md) for details on each named implementation if needed.

| Platform Component | Description of Enhancement                                                                          |
|------------------|-----------------------------------------------------------------------------------------------------|
| iDaaS-Connect    | Complete redesign and refactoring of components based on existing work efforts. v4 release.         |
| Community Survey | This survey will determine next years efforts and critical efforts about rebranding component names |
